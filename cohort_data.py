def unique_houses(filename):
    ...
    for line in open_file: 
        ...
        # old_code:
        # open_file = open_file.rstrip() = duh, does NOT work!! open_file is a file not a string
        # we need to iterate over the string binded to variable: line !!!
        #list_splitter = open_file.split("|")
        # open_file = open_file.rstrip() = duh, does NOT work!! open_file is a file not a string
        # we    # old_code:
        # open_file = open_file.rstrip() = duh, does NOT work!! open_file is a file not a string
        # we need to iterate over the string binded to variable: line !!!
        ...
        # open_file = open_file.rstrip() = duh, does NOT work!! open_file is a file not a string
        # we need to iterate over the string binded to variable: line !!!
        #print open_fileneed to iterate over the string binded to variable: line !!!
        #print open_file
